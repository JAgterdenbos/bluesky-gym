...
RTA_TOLERANCE = 1 * 60 / MAX_TIME # ±1 minute 
...
class PathPlanningGoalEnv(GoalEnv):
    ...
    def _get_info(self) -> dict:
        on_time = np.abs(self.goal_vector[2] - (self.simt / MAX_TIME)) <= RTA_TOLERANCE if self.use_rta else True
    ...
    def _get_terminated(self):  
        def _get_rta_penalty_mult():
            ...
            abs_x = np.abs(self.goal_vector[2] - (self.simt / MAX_TIME))
