...
if __name__ == "__main__":
    ...
    save_path = f"./pathplanning_models/{env_name}/{str(algorithm.__name__)}"

    save_callback = SaveModelCallback(save_freq=1000, save_path=save_path, verbose=1)
    ...
    model = algorithm.load(f"{save_path}/model", env=env)
